		...
		<div class="botbg" >
			<div class="mainbg" >
				...
				<table class="adminlist" >
                    ...
                    <tr>
                        <td width="16px">
                            <img src="<?php echo JURI::root(); ?>/administrator/components/com_joomblog/assets/images/draft.png" />
                        </td>
                        <td class="title">
                            <a class="menu_link" href="index.php?option=com_joomblog&view=drafts">
                                <?php echo JText::_('COM_JOOMBLOG_SUBMENU_DRAFTS'); ?>
                            </a>
                        </td>
                    </tr>
					<tr>
                    ...
                    <tr>
                        <td width="16px">
                            <img src="<?php echo JURI::root(); ?>/administrator/components/com_joomblog/assets/images/archive.png" />
                        </td>
                        <td class="title">
                            <a class="menu_link" href="index.php?option=com_joomblog&view=archives">
                                <?php echo JText::_('COM_JOOMBLOG_SUBMENU_ARCHIVES'); ?>
                            </a>
                        </td>
                    </tr>
					<tr>
