      ...
      <div class="filter-select fltrt">
        <select name="filter_roles_id" class="inputbox" onchange="this.form.submit()">
         ...
         <select name="filter_published" class="inputbox" onchange="this.form.submit()">
            ...
            <?php echo JHtml::_('select.options', JHtml::_('jgrid.publishedOptions', array('all'=>false,'archived'=>false,'trash'=>false)), 'value', 'text', $this->state->get('filter.published'), true);?>
         </select>
      </div>
