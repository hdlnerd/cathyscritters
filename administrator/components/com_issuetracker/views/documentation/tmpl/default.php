...
<h2>Summary</h2>
<ol>
   <span class=h5>Issue Tracker</span> is a simple implementation of a mechanism to track issues
...
<ol style="list-style-type: upper-roman;">
   ...
   <ol>
      ...
      <ul>
         Upload the zip file to Joomla using the component installer in the usual way.<br />
