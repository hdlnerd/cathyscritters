...
function updatePrice () {
	...
	var pictures     = 0;   //$('cc1_critters_reservations___reservations_photo').getElements('input')[0].checked;
	var numpics      = 0;   //$('cc1_critters_reservations___reservations_photo_quantity').getValue();
