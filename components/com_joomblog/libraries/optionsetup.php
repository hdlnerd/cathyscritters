...
* @version $Id: optionsetup.php 2011-03-16 17:30:15
* @package JoomBlog
* @subpackage optionsetup.php
	...
	function get_html()
	{
		...
		foreach($this->data  as $cfg)
		{
			...
			for($i = 1; $i < count($cfg); $i++)
			{
				...
				if($title){
					$img = "<img style='padding:0;margin:0px 5px 0px 0px;' src = '".JURI::base()."templates/bluestork/images/menu/icon-16-info.png' />";
				}else{
					$img = "";
				}
